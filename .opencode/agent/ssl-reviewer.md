---
description: Reviews STARLIMS SSL (v11) code against this repository's style guide and language rules and reports findings. Read-only — does not modify files. Use to review, lint, or check SSL code quality.
mode: all
tools:
  read: true
  grep: true
  ...
  bash: false
---
<!-- GENERATED from agent-guides/agents/ssl-reviewer.agent.md v1. Do not edit. Run: bun tools/generate-agents.mjs -->
