---
description: "Acts as an SSL developer: implements, reviews, and refactors STARLIMS SSL (v11) code following this repository's schema and agent guides. Use for general SSL coding work."
mode: primary
tools:
  read: true
  grep: true
  ...
  bash: true
---
<!-- GENERATED from agent-guides/agents/ssl-developer.agent.md v1. Do not edit. Run: bun tools/generate-agents.mjs -->
