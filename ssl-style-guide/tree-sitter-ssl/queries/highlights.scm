...
((builtin_class_instantiation class: (built_in_class_name) @type.builtin)
  (#match? @type.builtin "(?i)^(AzureStorage|BatchSupport|CDataTable|Email|EnterpriseExporter|FtpsClient|HtmlConverter|PatcherSupport|PdfSupport|RegSetup|SDMS|SDMSDocUploader|Sequence|SSLBaseDictionary|SSLCodeProvider|SSLDataset|SSLExpando|SSLIntDictionary|SSLRegex|SSLStringDictionary|TablesImport|WebServices)$"))
